...
conn2 = mysql.connector.connect(host="localhost", user="root", passwd="shr4l1f3", database="Test")

# create pointer
commander2 = conn2.cursor()
def show (cmd):
# sql command
    command1 = cmd
# command1 = ("SELECT age as 'you old',email FROM accounts")
# tells what sql command to do
    commander2.execute(command1)
